...
namespace Raique.Microservices.AuthenticateTests.UseCases
{
    ...
    public class GetTokenInfoTests
    {
        ...
        [TestMethod()]
        public void GetTokenInfoInvalidParametersTest(bool isTokenRepNull, bool isUserRepNull, string token, string appKey, string device)
        {
            ...
            try
            {
                GetTokenInfo.Execute(tokenRep, userRep, token, appKey, device);
                Assert.Fail();
            }
            catch (Exception ex)
            {
        ...
        [TestMethod()]
        public void CreateUserFlowTest(string token, string appKey, string device, bool callGetUserIdByTokenCount, bool callGetByIdCount)
        {
        ...
        [TestMethod()]
        public void LoginCodeTest(string token, string appKey, string device, bool exception, Type exceptionType = null)
        {
            var tokenRep = TokenRepositoryMock.CreateRepository();
            var userRep = UserRepositoryMock.CreateRepository();
            try
